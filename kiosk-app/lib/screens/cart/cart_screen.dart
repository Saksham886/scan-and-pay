  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            _Header(itemCount: cart.items.length, onClear: cart.isEmpty ? null : cart.clear),
            Container(height: 2, color: CustomerColors.border, margin: const EdgeInsets.symmetric(horizontal: 20)),
            Expanded(
              child: cart.isEmpty
                  ? const _EmptyCart()
                  : ListView.separated(
                      ...
                      itemBuilder: (context, index) => _CartRow(item: cart.items[index], cart: cart),
                    ),
            ),
...
class _Header extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          _SquareIconButton(icon: Icons.arrow_back, onTap: () => Navigator.of(context).pop()),
          ...
          Container(
            ...
            child: const Icon(Icons.shopping_bag_outlined, size: 16, color: CustomerColors.primary),
          ),
          ...
          if (onClear != null)
            NeoPressable(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(border: Border.all(color: CustomerColors.danger.withValues(alpha: 0.4))),
                child: Text(
                  'CLEAR',
                  style: CustomerText.mono(fontSize: 11, fontWeight: FontWeight.w700, color: CustomerColors.danger),
                ),
              ),
            ),
        ],
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            alignment: Alignment.center,
            decoration: BoxDecoration(border: Border.all(color: CustomerColors.border, width: 2)),
            child: const Icon(Icons.shopping_bag_outlined, size: 32, color: CustomerColors.border),
          ),
    ...
    return Container(
      ...
      child: Row(
        children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        ...
                        style: CustomerText.display(fontSize: 14, letterSpacing: -0.2),
                      ),
                    ),
                  ],
                ),
          ...
          const SizedBox(width: 10),
          Container(
            decoration: BoxDecoration(color: CustomerColors.background, border: Border.all(color: CustomerColors.border, width: 2)),
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                _StepIcon(
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    border: Border.symmetric(vertical: BorderSide(color: CustomerColors.border, width: 2)),
                  ),
                  child: Text(
                    '${item.quantity}',
                ...
                _StepIcon(
                  icon: Icons.add,
                  danger: false,
                  onTap: () => cart.updateQuantity(item.menuItemId, item.quantity + 1),
                ),
              ],
            ),
          ),
          ...
          SizedBox(
            ...
            child: Text(
              ...
              style: CustomerText.mono(fontSize: 13, fontWeight: FontWeight.w700, color: CustomerColors.accent),
            ),
          ),
        ],
      ),
...
class _StepIcon extends StatelessWidget {
  ...
  const _StepIcon({required this.icon, required this.danger, required this.onTap});
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: SizedBox(
        width: 44,
        height: 44,
        child: Icon(icon, size: 15, color: danger ? CustomerColors.danger : CustomerColors.muted),
      ),
    );
  }
}
        ...
        children: [
          Row(
            ...
            children: [
              Text(
                'TOTAL AMOUNT',
                style: CustomerText.mono(fontSize: 13, letterSpacing: 1, color: CustomerColors.muted),
              ),
              Text(
                paiseToCurrencyShort(total),
                style: CustomerText.display(fontSize: 24, color: CustomerColors.accent),
              ),
            ],
          ),
          const SizedBox(height: 16),
